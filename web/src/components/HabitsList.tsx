...
export function HabitsList({ date, onCompletedChanged }: HabitListProps) {
  ...
  async function handleToggleHabit(habitId: string){
    ...
    if(isHabitAlreadyCompleted) {
      completedHabits = habitsInfo!.completedHabits.filter(id => id !== habitId)  //remover o hábito da lista
 
      
    } else {
      completedHabits = [...habitsInfo!.completedHabits, habitId] //adicionar o hábito à lista
    }
    setHabitsInfo({
